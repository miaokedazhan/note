	...
	<div id="main">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; ${fns:getConfig('copyYear')} ${fns:getConfig('productName')} - Powered By <a href=${fns:getConfig('companyIndex')} target="_blank">${fns:getConfig('company')}</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
